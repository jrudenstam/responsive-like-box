...
else{if(settings.initialTimeout){setTimeout(widget.iframe.resize,500);}else{loader.hide();}
settings.initialTimeout--;}}};if(JSON&&window.getComputedStyle){widget.init();}});};})(jQuery);